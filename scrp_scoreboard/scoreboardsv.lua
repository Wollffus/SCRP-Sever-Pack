...
RegisterServerEvent("scrp_scoreboard:GetBoard")
AddEventHandler("scrp_scoreboard:GetBoard", function(ptable, key)
	...
	TriggerClientEvent("scrp_scoreboard:Show", _source, players, key)
end)
