...
RegisterNetEvent('scrpchat:localMessage')
RegisterNetEvent('scrpchat:action')
RegisterNetEvent('scrpchat:whisperEcho')
RegisterNetEvent('scrpchat:whisper')
RegisterNetEvent('scrpchat:whisperError')
RegisterNetEvent('scrpchat:setReplyTo')
RegisterNetEvent('scrpchat:staffMessage')
RegisterNetEvent('scrpchat:setPermissions')

function GlobalCommand(source, args, user)
	TriggerServerEvent('scrpchat:globalMessage', table.concat(args, ' '))
end
...
RegisterCommand('me', function(source, args, raw)
	TriggerServerEvent('scrpchat:actionMessage', table.concat(args, ' '))
end, false)
...
function WhisperCommand(source, args, user)
	...
	TriggerServerEvent('scrpchat:whisperMessage', id, message)
end
...
function ReplyCommand(source, args, user)
	if ReplyTo then
		local message = table.concat(args, " ")
		TriggerServerEvent('scrpchat:whisperMessage', ReplyTo, message)
	else
...
AddEventHandler('scrpchat:setReplyTo', function(id)
	ReplyTo = tostring(id)
end)
...
RegisterCommand('staff', function(source, args, raw)
	...
	TriggerServerEvent('scrpchat:staffMessage', message)
end)

AddEventHandler('scrpchat:setPermissions', function(permissions)
...
RegisterCommand('report', function(source, args, raw)
	...
	TriggerServerEvent('scrpchat:report', player, reason)
end, false)

CreateThread(function()
	TriggerServerEvent('scrpchat:getPermissions')
